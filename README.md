...
This is a script that uses similar smarts to the [crypto ticker](https://github.com/llvllch/btcticker), but to display randomly-chosen highly-rated **quotes** from Reddit (r/quotes), a **word of the day**, a item from a **flashcard** text file or a **stoic quote** (selected at random, according to weightings in config file `config.yaml`)
