...
This is a script that uses similar smarts to the [crypto ticker](https://github.com/veebch/btcticker). It displays randomly-chosen highly-rated **quotes** from Reddit (r/quotesporn), a **word of the day**, a item from a **flashcard** text file or a **stoic quote** using a Raspberry Pi Zero and an ePaper screen.
