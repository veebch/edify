...
This is a script that uses similar smarts to the [crypto ticker](https://github.com/veebch/btcticker), but to display randomly-chosen highly-rated **quotes** from Reddit (r/quotesporn), a **word of the day**, a item from a **flashcard** text file or a **stoic quote** 
